...
public class SecurityConfig {
     ...
     */
    @Value("${app.cors.allowed-origins:http://localhost:4200,http://localhost:4300,http://54.225.63.207:4300,http://54.225.63.207,http://3.82.49.182:4300,http://3.82.49.182}")
